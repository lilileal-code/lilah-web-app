...
|-------|----------|------------------|---------------------------|----------------|
| ADR-00 | e.g. "Frontend: React; Backend/DB: Supabase" | R1–R5 (all) | Next.js+Postgres, Firebase | Team familiarity, built-in auth, fast to prototype |
| ADR-01 | e.g. "Use email/password login, not social login" | R1, R2 | Social login | Faster to ship, no third-party dependency |
